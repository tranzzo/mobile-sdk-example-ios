...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TranzzoPaymentSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC17TranzzoPaymentSDK18CollectionDirector")
@interface CollectionDirector : NSObject <UICollectionViewDataSource, UICollectionViewDataSourcePrefetching, UICollectionViewDelegate>
...
@interface CollectionDirector (SWIFT_EXTENSION(TranzzoPaymentSDK))
...
- (BOOL)collectionView:(UICollectionView * _Nonnull)collectionView shouldSpringLoadItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath withContext:(id <UISpringLoadedInteractionContext> _Nonnull)context SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=11.0);
...
SWIFT_CLASS("_TtC17TranzzoPaymentSDK30ConstraintWithKeyboardObserver")
@interface ConstraintWithKeyboardObserver : NSLayoutConstraint
- (void)awakeFromNib;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC17TranzzoPaymentSDK22FlowCollectionDirector")
@interface FlowCollectionDirector : CollectionDirector <UICollectionViewDelegateFlowLayout>
@end


@interface FlowCollectionDirector (SWIFT_EXTENSION(TranzzoPaymentSDK))
...
SWIFT_CLASS("_TtC17TranzzoPaymentSDK13TableDirector")
@interface TableDirector : NSObject <UITableViewDataSourcePrefetching>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface TableDirector (SWIFT_EXTENSION(TranzzoPaymentSDK)) <UITableViewDataSource, UITableViewDelegate>
...
- (UIView * _Nullable)tableView:(UITableView * _Nonnull)tableView viewForHeaderInSection:(NSInteger)sectionIdx SWIFT_WARN_UNUSED_RESULT;
- (UIView * _Nullable)tableView:(UITableView * _Nonnull)tableView viewForFooterInSection:(NSInteger)sectionIdx SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForHeaderInSection:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForFooterInSection:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView estimatedHeightForHeaderInSection:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView estimatedHeightForFooterInSection:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
